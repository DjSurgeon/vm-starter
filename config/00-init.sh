...
# -----------------------------------------------------------------------------
# Distro Selection (Ubuntu Only)
# -----------------------------------------------------------------------------
export SELECTED_DISTRO="ubuntu"

# -----------------------------------------------------------------------------
# Define all important directory paths used throughout the project.
# -----------------------------------------------------------------------------
# Store large binaries (VMs and ISOs) in DEVPOD_ROOT. Can be overridden in config/local_env.sh
export DEVPOD_ROOT="${DEVPOD_ROOT:-${HOME}/.devpod}"
...
PRESEED_DIR="${BASE_DIR}/preseeds"				# Folder for preseed.cfg (Legacy, can be removed)
