...
# -----------------------------------------------------------------------------
TYPE_OPTIONS=("Web (Node.js, Docker, pnpm)" "Inception (42 Project Structure)" "Inception GUI (42 Project Structure + XFCE)" "C-Pure (42 Cursus, gcc, valgrind)" "C++98 (42 Cursus, g++, clang-format)")
...
if [[ "$UI_SELECT_RESULT" -eq 0 ]]; then
    ...
    PROJECT_TYPE="inception-gui"
elif [[ "$UI_SELECT_RESULT" -eq 3 ]]; then
    PROJECT_TYPE="c-pure"
else
    PROJECT_TYPE="cpp-98"
fi
